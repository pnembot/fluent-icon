...
export function DocumentUnknownFilled(props: Omit<SVGProps<SVGSVGElement>, 'viewBox'|'xmlns'>) {
  ...
  return (
    ...
    >
      <g fill="none">
        <path
          d="M10 2v4.5A1.5 1.5 0 0 0 11.5 8H16v8.5a1.5 1.5 0 0 1-1.5 1.5H9.743A5.5 5.5 0 0 0 4 9.207V3.5A1.5 1.5 0 0 1 5.5 2H10z"
          fill="currentColor"
        />
        <path
          d="M11 2.25V6.5a.5.5 0 0 0 .5.5h4.25L11 2.25z"
          fill="currentColor"
        />
        <path
...
export default DocumentUnknownFilled;
