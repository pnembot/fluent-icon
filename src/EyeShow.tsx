...
export function EyeShow(props: Omit<SVGProps<SVGSVGElement>, 'viewBox'|'xmlns'>) {
  ...
  return (
    ...
    >
      <g fill="none">
        ...
        />
        <path
          d="M10 8a3.5 3.5 0 1 0 0 7a3.5 3.5 0 0 0 0-7zm-2.5 3.5a2.5 2.5 0 1 1 5 0a2.5 2.5 0 0 1-5 0z"
          fill="currentColor"
        />
      </g>
    </svg>
