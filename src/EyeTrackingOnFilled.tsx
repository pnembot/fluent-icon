...
export function EyeTrackingOnFilled(props: Omit<SVGProps<SVGSVGElement>, 'viewBox'|'xmlns'>) {
  ...
  return (
    ...
    >
      <g fill="none">
        <path
          d="M4.5 3A1.5 1.5 0 0 0 3 4.5v3a.5.5 0 0 1-1 0v-3A2.5 2.5 0 0 1 4.5 2h3a.5.5 0 0 1 0 1h-3z"
          fill="currentColor"
        />
        <path
          d="M4.5 17A1.5 1.5 0 0 1 3 15.5v-3a.5.5 0 0 0-1 0v3A2.5 2.5 0 0 0 4.5 18h3a.5.5 0 0 0 0-1h-3z"
          fill="currentColor"
        />
        <path
          d="M17 4.5A1.5 1.5 0 0 0 15.5 3h-3a.5.5 0 0 1 0-1h3A2.5 2.5 0 0 1 18 4.5v3a.5.5 0 0 1-1 0v-3z"
          fill="currentColor"
        />
        <path
          d="M15.5 17a1.5 1.5 0 0 0 1.5-1.5v-3a.5.5 0 0 1 1 0v3a2.5 2.5 0 0 1-2.5 2.5h-3a.5.5 0 0 1 0-1h3z"
          fill="currentColor"
        />
        <path d="M7 11.5a3 3 0 1 1 6 0a3 3 0 0 1-6 0z" fill="currentColor" />
        <path
