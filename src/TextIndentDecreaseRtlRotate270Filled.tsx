...
export function TextIndentDecreaseRtlRotate270Filled(props: Omit<SVGProps<SVGSVGElement>, 'viewBox'|'xmlns'>) {
...
export default TextIndentDecreaseRtlRotate270Filled;
