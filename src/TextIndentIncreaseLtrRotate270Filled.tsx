...
export function TextIndentIncreaseLtrRotate270Filled(props: Omit<SVGProps<SVGSVGElement>, 'viewBox'|'xmlns'>) {
...
export default TextIndentIncreaseLtrRotate270Filled;
