...
export function TextIndentIncreaseRtlRotate270Filled(props: Omit<SVGProps<SVGSVGElement>, 'viewBox'|'xmlns'>) {
...
export default TextIndentIncreaseRtlRotate270Filled;
